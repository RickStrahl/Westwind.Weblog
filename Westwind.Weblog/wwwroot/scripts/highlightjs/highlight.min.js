...
end:/$/}]}}})();hljs.registerLanguage("diff",e)})();/*! `dos` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("dos",e)})();/*! `fsharp` grammar compiled for Highlight.js 11.11.1 */
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[N]}]}}})()
;hljs.registerLanguage("handlebars",e)})();/*! `ini` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("python-repl",a)})();/*! `ruby` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict";return e=>{
