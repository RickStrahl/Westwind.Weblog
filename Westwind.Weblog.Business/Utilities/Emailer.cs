...
namespace Westwind.Webstore.Business.Utilities
{
    ...
    public class Emailer
    {
        ...
        /// etc.
        /// </summary>
        /// <param name="recipient">recipient email or `name &lt;name@email.com&gt;` ></param>
        ...
        /// <returns></returns>
        public bool SendEmail(string recipient, string subject, string messageText, EmailModes emailMode = EmailModes.plain)
        {
            var emailConfig = wlApp.Configuration.Email;
